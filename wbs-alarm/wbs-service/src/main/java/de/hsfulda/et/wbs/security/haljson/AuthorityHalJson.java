...
import static de.hsfulda.et.wbs.Relations.REL_GRANT_AUTHORITY;
...
public class AuthorityHalJson extends HalJsonResource {
    ...
    public AuthorityHalJson(WbsUser user, final AuthorityData authority, final BenutzerData benutzer) {
        addLink(Link.create("delete", UriUtil.build(REL_GRANT_AUTHORITY, authority.getId(), benutzer.getId())));
